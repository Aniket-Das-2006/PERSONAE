...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Consult 208 reconstructed minds from history. Press / to summon one." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "PERSONAE — The Living Archive" },
      { property: "og:description", content: "A conversational archive of history's great minds." },
